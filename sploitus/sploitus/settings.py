"""
Django settings for sploitus project.
...
WSGI_APPLICATION = 'sploitus.wsgi.application'

ASGI_APPLICATION = 'sploitus.asgi.application'
# Database
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        'rest_framework.renderers.JSONRenderer',  # Отключаем интерфейс
    ]
}
